...
NOTES = {
 ...
 "The Lands of the Realm": ("Merlin's Hut; reinforced by map and zone-name displays.",
    "Names the main lands, and notes that the four caves were dug on purpose rather than formed by nature."),
 "The Worldtree": ("Merlin's Hut; hinted again when Fire unlocks; discovered in the far northeast.",
    "Explains the tree, the fire-arrow key, and warns that burning it leaves one seed that must not be lost."),
 "The Worldtree Seed": ("Merlin's Hut, but only after the Worldtree has burned and the seed is in hand.",
    "Explains that the seed can be planted anywhere, only takes root in the ash it came from, and can be dug up again."),
